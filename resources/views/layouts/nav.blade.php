<nav id="sidebar" class="sidebar js-sidebar ">
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
                    ...
                    <ul id="dashboards" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" >
                        @can('view-any', App\Models\User::class)
                            <li class="sidebar-item {{ request()->is('users*') ? 'active' : '' }}">
                                <a class="sidebar-link"  href="{{ route('users.index') }}" ><span class="align-middle">Usuários</span> </a>
                            </li>
                        @endcan
            ...
            <li class="sidebar-item">
                <a data-bs-target="#Local" data-bs-toggle="collapse" class="sidebar-link {{ request()->is('empresas*') ? 'collapsed' : '' }} " aria-expanded="false">
                    <i class="align-middle" data-feather="map"></i>
                <span class="align-middle">Empresas</span>
                </a>
                <ul id="Local" class="sidebar-dropdown list-unstyled collapse {{ request()->is('empresas*') ? 'show' : '' }}" data-bs-parent="#sidebar" >
            ...
            <li class="sidebar-item">
                <a data-bs-target="#convenios" data-bs-toggle="collapse" class="sidebar-link {{ request()->is('convenios*') ? 'collapsed' : '' }} " aria-expanded="false">
                    <i class="fa-solid fa-file-invoice"></i>
                <span class="align-middle">Convenios</span>
                </a>
                <ul id="convenios" class="sidebar-dropdown list-unstyled collapse {{ request()->is('convenios*') ? 'show' : '' }}" data-bs-parent="#sidebar" >
