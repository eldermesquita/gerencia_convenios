        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                ...
                <ul id="dashboards" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-any', App\Models\Usuario::class)): ?>
                    <li class="sidebar-item <?php echo e(request()->is('usuarios*') ? 'active' : ''); ?>">
                        <a class="sidebar-link" href="<?php echo e(route('usuarios.index')); ?>"><span
            ...
            <li class="sidebar-item">
                <a data-bs-target="#Local" data-bs-toggle="collapse"
                    class="sidebar-link <?php echo e(request()->is('empresas*') ? 'collapsed' : ''); ?> " aria-expanded="false">
                    <i class="align-middle" data-feather="map"></i>
                    <span class="align-middle">Empresas</span>
                </a>
                <ul id="Local"
                    class="sidebar-dropdown list-unstyled collapse <?php echo e(request()->is('empresas*') ? 'show' : ''); ?>"
            ...
            <li class="sidebar-item">
                <a data-bs-target="#convenios" data-bs-toggle="collapse"
                    class="sidebar-link <?php echo e(request()->is('convenios*') ? 'collapsed' : ''); ?> " aria-expanded="false">
                    <i class="fa-solid fa-file-invoice"></i>
                    <span class="align-middle">Convenios</span>
                </a>
                <ul id="convenios"
                    class="sidebar-dropdown list-unstyled collapse <?php echo e(request()->is('convenios*') ? 'show' : ''); ?>"
                    data-bs-parent="#sidebar">
